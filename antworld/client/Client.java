...
/**
 * The client for AntWorld. The main method in this class should be the run configuration if unit testing is not being
 * done.
 * 
  ...
  public void mainGameLoop(CommData data)
  {
    ...
    while (true)
    {
      ...
      if (i % 20 == 0)
      {
        ...
        {
          System.out.println("=================================================================");
          System.out.println("There are " + Client.foodManager.getAllFood().size() + " food packets.");
          System.out.println("=================================================================");
        }
      }
      if (i % 100 == 0)
      {
        ...
        FoodManager.setFoodTotal(AntUtilities.getTotalFoodCount(data.foodStockPile));
        System.out.println("Food Stockpile Total: " + FoodManager.getFoodTotal());
        FoodManager.setWaterTotal(data.foodStockPile[1]);
