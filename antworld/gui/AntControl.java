...
public class AntControl extends JTabbedPane
{
	...
	{		
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				Point location = new Point(Integer.parseInt(this.goLocationX.getText()), Integer.parseInt(this.goLocationY.getText()));
				//TODO Tell ants to go to the specified location.
			}
			else if (event == this.goNestButton)
			{
				//TODO Get the location of the selected nest and tell the ants to go there.
			}
